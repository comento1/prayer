...
다음 규칙으로 기도 제목과 기도문을 정리해주세요. 질문하지 말고 반드시 JSON만 출력하세요.

[정리 규칙 - 반드시 존댓말]
- 하나님께 드리는 기도이므로 **반드시 존댓말**로 작성할 것. 반말(해줘, 좋겠어, 원해, 싶어 등) 사용 금지.
- 기도 제목(text): "~해 주시옵소서", "~주시면 감사하겠습니다", "~함께해 주시길 바랍니다" 등 존댓말 한 문장.
- 풀어쓴 기도문(expandedPrayer): "~해 주시옵소서", "~주시길 원합니다", "~감사하겠습니다" 등 하나님께 드리는 존댓말 2~3문장. 따뜻하되 경건한 톤 유지.
- 너무 짧으면 맥락을 살려 한 문장으로 풀어쓰기, 길면 핵심만 요약.
- 청년부 공동체에서 나누기 좋은 따뜻하고 정돈된 톤이되, 하나님께 대한 존댓말은 지킬 것.

[출력 형식 - 반드시 이 JSON만 출력]
{
  "type": "refined",
  "text": "다듬어진 기도 제목 한 문장 (존댓말)",
  "expandedPrayer": "작성한 내용을 2~3문장으로 풀어쓴 기도문 (하나님께 드리는 존댓말)",
